...
public struct FailureDetails_FailureDetail {
  ...
  public enum OneOf_Category: Equatable {
    ...
    public static func ==(lhs: FailureDetails_FailureDetail.OneOf_Category, rhs: FailureDetails_FailureDetail.OneOf_Category) -> Bool {
      ...
      case (.modCommand, .modCommand): return {
        guard case .modCommand(let l) = lhs, case .modCommand(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct FailureDetails_ModCommand {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension FailureDetails_ModCommand.Code: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [FailureDetails_ModCommand.Code] = [
    .modCommandUnknown,
    .missingArguments,
    .tooManyArguments,
    .invalidArguments,
...
extension FailureDetails_ModCommand: @unchecked Sendable {}
extension FailureDetails_ModCommand.Code: @unchecked Sendable {}
